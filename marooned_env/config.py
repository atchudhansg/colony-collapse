...
#TEMPORAL REWARDS(NEW)
REWARD_EARLY_EXPLORATION = 0.05 
REWARD_EARLY_RESOURCE_DIVERSITY = 0.08

#Mid Game
REWARD_MID_COORDINATION = 0.15
REWARD_MID_SHIP_MOMENTUM = 0.12

#Late Game
REWARD_LATE_URGENCY = 0.20
REWARD_LATE_EFFICIENCY = 0.18

#SOCIAL INTELLIGENCE REWARDS
REWARD_EVIDENCE_GATHERING = 0.25
REWARD_ACCURATE_ACCUSATION = 5.0
REWARD_COMMUNICATION_RELEVANCE = 0.08
REWARD_TEAM_COORDINATION = 0.12

#TRAITOR DECEPTION
REWARD_SUCCESSFUL_DEFLECTION = 3.0
REWARD_FALSE_EVIDENCE_PLANT = 2.5
REWARD_STRATEGIC_SABOTAGE = 2.0
REWARD_POISON_STEALTH = 8.0

##### INFORMATION ASSYMETRY REWARDS(NEW) 
#COLONISTS Learning
REWARD_SYMPTOM_DETECTION = 3.0
REWARD_PATTERN_RECOGNITION = 0.40
REWARD_EVIDENCE_CORRELATION = 0.50

#Traitor Advantage
REWARD_VISION_UTILIZATION = 0.15
REWARD_KNOWLEDGE_EXPLOITATION = 0.25


##### EFFICIENCY & SURVIVAL REWARDS
REWARD_ENERGY_OPTIMAL = 0.05
PENALTY_ENERGY_CRITICAL = -0.30
REWARD_FOOD_TIMING = 0.10

#RESOURCE EFFICIENCY
REWARD_BACKPACK_MANAGEMENT = 0.08
